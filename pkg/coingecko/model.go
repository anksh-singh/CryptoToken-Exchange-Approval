...
type TokenInfoResponse struct {
	...
	Chart   TokenChart    `json:"chart"`
	Utility []interface{} `json:"utility"` //Returns empty array if data  not found
}
...
type TokenInfo struct {
	...
	Symbol          string      `json:"symbol"`
	Name            string      `json:"name"`
	AssetPlatformID interface{} `json:"asset_platform_id,omitempty"`
	Platforms       struct {
		...
		Moonbeam               string `json:"moonbeam,omitempty"`
		Solana                 string `json:"solana,omitempty"`
		Tomochain              string `json:"tomochain,omitempty"`
		Fantom                 string `json:"fantom,omitempty"`
		HarmonyShard0          string `json:"harmony-shard-0,omitempty"`
		ArbitrumOne            string `json:"arbitrum-one,omitempty"`
		OkexChain              string `json:"okex-chain,omitempty"`
		Moonriver              string `json:"moonriver,omitempty"`
		Sora                   string `json:"sora,omitempty"`
		...
		MetisAndromeda         string `json:"metis-andromeda,omitempty"`
		Fuse                   string `json:"fuse,omitempty"`
		KucoinCommunityChain   string `json:"kucoin-community-chain,omitempty"`
		Meter                  string `json:"meter,omitempty"`
		Avalanche              string `json:"avalanche,omitempty"`
		Telos                  string `json:"telos,omitempty"`
		Syscoin                string `json:"syscoin,omitempty"`
		MilkomedaCardano       string `json:"milkomeda-cardano,omitempty"`
		DefiKingdomsBlockchain string `json:"defi-kingdoms-blockchain,omitempty"`
		Evmos                  string `json:"evmos,omitempty"`
		SxNetwork              string `json:"sx-network,omitempty"`
		Energi                 string `json:"energi,omitempty"`
	...
	HashingAlgorithm   interface{}   `json:"hashing_algorithm,omitempty"`
	...
	CountryOrigin                interface{} `json:"country_origin"`
	...
	CoingeckoRank                interface{} `json:"coingecko_rank"`
	CoingeckoScore               interface{} `json:"coingecko_score"`
	DeveloperScore               interface{} `json:"developer_score"`
	CommunityScore               interface{} `json:"community_score"`
	LiquidityScore               interface{} `json:"liquidity_score"`
	PublicInterestScore          interface{} `json:"public_interest_score"`
	MarketData                   struct {
		CurrentPrice struct {
	...
	DeveloperData struct {
		...
		TotalIssues                  float64 `json:"total_issues"`
		ClosedIssues                 float64 `json:"closed_issues"`
		PullRequestsMerged           float64 `json:"pull_requests_merged"`
		PullRequestContributors      float64 `json:"pull_request_contributors"`
		...
		CommitCount4Weeks              float64   `json:"commit_count_4_weeks"`
		Last4WeeksCommitActivitySeries []float64 `json:"last_4_weeks_commit_activity_series"`
	} `json:"developer_data"`
	...
	Tickers     []struct {
		...
		TrustScore             interface{} `json:"trust_score"`
		BidAskSpreadPercentage interface{} `json:"bid_ask_spread_percentage"`
		Timestamp              interface{} `json:"timestamp"`
		LastTradedAt           interface{} `json:"last_traded_at"`
		LastFetchAt            interface{} `json:"last_fetch_at"`
		IsAnomaly              bool        `json:"is_anomaly"`
		IsStale                bool        `json:"is_stale"`
		TradeURL               string      `json:"trade_url"`
		TokenInfoURL           interface{} `json:"token_info_url"`
...
type QuoteData struct {
	QuoteRateChange24h    string
	QuoteRatePctChange24h float64
}
